...
public:
	...
	Client(size_t channels, enet_uint32 incomingBW = 0, enet_uint32 outgointBW = 0) 
		: host(enet_host_create(nullptr, 1, channels, incomingBW, outgointBW)){}
	void create_host(size_t channels, enet_uint32 incomingBW = 0, enet_uint32 outgointBW = 0) {
		host = enet_host_create(nullptr, 1, channels, incomingBW, outgointBW);
	}
	...
	void connect(size_t channels, enet_uint32 data = 0) {
	...
	void send_packet(ENetPacket* packet,enet_uint8 channel) {
