...
public:
	...
	Server(enet_uint16 port, size_t max_peers, size_t channels = 1, enet_uint32 incomingBW = 0, enet_uint32 outgointBW = 0) : address(ENET_HOST_ANY, port), host(enet_host_create(&address,max_peers,channels,incomingBW,outgointBW)){}
	void create_host(enet_uint16 port, size_t max_peers, size_t channels = 1, enet_uint32 incomingBW = 0, enet_uint32 outgointBW = 0) {
