...
enum ServerOpcode : enet_uint8 { ADD_USER, DELETE_USER, LOG_IN, LOG_OUT, SEND_MESSAGE, SEND_COMMAND, FILE_HEADER };//opcodes que interpreta el servidor
enum ClientOpcode : enet_uint8 { SIGNIN_SUCCESS, SIGNIN_ERROR ,LOGIN_SUCCESS, LOGIN_ERROR, LOGOUT_SUCCESS, LOGOUT_ERROR, DELETE_USER_SUCCESS, DELETE_USER_ERROR, SUBMIT_SUCCESS, SUBMIT_ERROR, DIRECT_MESSAGE, GENERAL_MESSAGE, COMMAND, TRANSFERENCE_ID, INCOMING_FILE_HEADER, FILE_HEADER_ERROR, FILE_CHUNK };//opcodes que interpreta el cliente
